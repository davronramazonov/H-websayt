...
const uz = {
  common: {
    ...
    openMarketOpportunity: "Ochiq bozor imkoniyati",
  ...
  market: {
    ...
    subheadline: "H+ O'zbekiston, Qozog'iston, Qirg'iziston, Tojikiston va Turkmanistonni bosqichlarga ajratilgan yo'nalishlar emas, balki sharoiti va ehtiyoji alohida baholanadigan ochiq mintaqaviy imkoniyatlar sifatida ko'radi.",
    ...
    countriesData: {
      uzbekistan: { name: "O'zbekiston", mapName: "O'zbekiston", desc: "Aholi ko'lami, xususiy tibbiyotning rivojlanishi va raqamlashtirishga talab bilan ajralib turadigan ochiq bozor imkoniyati.", popVal: "37M+", privateClinicsVal: "9,000+", growthVal: "~10-15%", confidenceVal: "Yuqori", digitVal: "O'sish bosqichida", opportunity: "Klinika workflowlarini pilot orqali tekshirish va mahalliy hamkorliklarni o'rganish uchun kuchli imkoniyat.", dataNote: "Ochiq manbalarda xususiy klinikalar 2016-yildagi 3,200 atrofidan 2026-yil yakunida 8,700 taga yetishi kutilayotgani va 2025-yilda 1,329 ta yangi xususiy klinika litsenziya olgani ko'rsatilgan." },
      kazakhstan: { name: "Qozog'iston", mapName: "Qozog'iston", desc: "Xarid qobiliyati va sug'urta bilan bog'langan provider ekotizimi rivojlangan ochiq mintaqaviy imkoniyat.", popVal: "20M+", privateClinicsVal: "1,200+", growthVal: "~7% CAGR", confidenceVal: "O'rta", digitVal: "O'rta", opportunity: "Providerlar, sug'urta va klinika tarmoqlari bilan moslashuvchan hamkorlik modelini o'rganish imkoniyati.", dataNote: "Bu raqam barcha xususiy klinikalar emas, davlat buyurtmasi yoki sug'urta tizimi bilan ishlayotgan xususiy providerlar bo'yicha ochiq indikator sifatida ishlatiladi." },
      ...
      tajikistan: { name: "Tojikiston", mapName: "Tojikiston", desc: "Raqamli tibbiyotga ehtiyoj yuqori va xususiy sektor asta-sekin kengayayotgan ochiq bozor imkoniyati.", popVal: "10M+", privateClinicsVal: "900", growthVal: "~12% recent", confidenceVal: "O'rta", digitVal: "Past", opportunity: "Mahalliy ehtiyojlarga mos raqamli infratuzilma va hamkorlik modelini o'rganish imkoniyati.", dataNote: "Ochiq xabarlarda 2024-yilda 801+ xususiy tibbiyot muassasasi, 2025-yilda esa 900 ta xususiy tibbiyot muassasasi faoliyat yuritayotgani ko'rsatilgan." },
      turkmenistan: { name: "Turkmaniston", mapName: "Turkmaniston", desc: "Ochiq ma'lumotlari cheklangan, sharoiti alohida o'rganilishi kerak bo'lgan mintaqaviy bozor imkoniyati.", popVal: "6M+", privateClinicsVal: "Limited data", growthVal: "N/A", confidenceVal: "Past", digitVal: "Juda past", opportunity: "Ishonchli ma'lumot va mahalliy hamkorlar mavjud bo'lganda alohida baholanadigan ochiq imkoniyat.", dataNote: "Ishonchli ochiq clinic-count data topilmagan. Manbalarda xususiy tibbiyot sektori juda kichik yoki cheklangan deb tasvirlanadi, shuning uchun aniq son yozilmasin." }
    },
    drivers: {
...
const en = {
  ...
  market: {
    ...
    subheadline: "H+ views Uzbekistan, Kazakhstan, Kyrgyzstan, Tajikistan, and Turkmenistan as open regional opportunities to evaluate on their own conditions, rather than as fixed sequential expansion stages.",
    ...
    countriesData: {
      uzbekistan: { name: "Uzbekistan", mapName: "Uzbekistan", desc: "An open market opportunity distinguished by population scale, private healthcare growth, and increasing demand for digitized workflows.", popVal: "37M+", privateClinicsVal: "9,000+", growthVal: "~10-15%", confidenceVal: "High", digitVal: "Growth stage", opportunity: "A strong opportunity to validate clinic workflows through pilots and explore local partnerships.", dataNote: "Public sources report growth from around 3,200 private clinics in 2016 toward an expected 8,700 by end-2026, while more than 1,300 private clinics received licenses in 2025." },
      kazakhstan: { name: "Kazakhstan", mapName: "Kazakhstan", desc: "An open regional opportunity with higher purchasing power and a more developed insurance-linked provider ecosystem.", popVal: "20M+", privateClinicsVal: "1,200+", growthVal: "~7% CAGR", confidenceVal: "Medium", digitVal: "Medium", opportunity: "An opportunity to explore flexible partnership models with providers, insurers, and clinic networks.", dataNote: "Publicly available data is stronger for private providers participating in the state-funded / insurance system than for all private clinics. Use this as documented provider-count data, not as total private clinic count." },
      ...
      tajikistan: { name: "Tajikistan", mapName: "Tajikistan", desc: "An open market opportunity with strong digital healthcare needs and a gradually expanding private sector.", popVal: "10M+", privateClinicsVal: "900", growthVal: "~12% recent", confidenceVal: "Medium", digitVal: "Low", opportunity: "An opportunity to explore locally adapted digital infrastructure and partnership models.", dataNote: "Public reporting indicates growth from 801+ private medical institutions in 2024 to around 900 in 2025. Long-term growth from 2012 is closer to low single digits, so the trend should not be overstated." },
      turkmenistan: { name: "Turkmenistan", mapName: "Turkmenistan", desc: "A regional market opportunity that requires separate evaluation because reliable public information is limited.", popVal: "6M+", privateClinicsVal: "Limited data", growthVal: "N/A", confidenceVal: "Low", digitVal: "Very low", opportunity: "An open opportunity to assess when reliable data and suitable local partners become available.", dataNote: "Reliable public clinic-count data is not available. Public sources describe the private healthcare sector as very small or limited. Do not invent a number." }
    },
    drivers: {
      title: "Why now?",
...
const ru = {
  ...
  common: {
    ...
    language: "Язык",
    openMarketOpportunity: "Открытая рыночная возможность"
  },
  product: {
  ...
  market: {
    ...
    subheadline: "H+ рассматривает Узбекистан, Казахстан, Кыргызстан, Таджикистан и Туркменистан как открытые региональные возможности, оцениваемые по собственным условиям, а не как фиксированные последовательные этапы расширения.",
    ...
    countriesData: {
      uzbekistan: { name: "Узбекистан", mapName: "Узбекистан", desc: "Открытая рыночная возможность, выделяющаяся масштабом населения, ростом частной медицины и спросом на цифровизацию процессов.", popVal: "37M+", privateClinicsVal: "9,000+", growthVal: "~10-15%", confidenceVal: "Высокая", digitVal: "Стадия роста", opportunity: "Сильная возможность проверить клинические процессы через пилоты и изучить локальные партнерства.", dataNote: "Открытые источники указывают рост частных клиник примерно с 3,200 в 2016 году до ожидаемых 8,700 к концу 2026 года; в 2025 году лицензии получили более 1,300 новых частных клиник." },
      kazakhstan: { name: "Казахстан", mapName: "Казахстан", desc: "Открытая региональная возможность с более высокой покупательной способностью и развитой страховой экосистемой провайдеров.", popVal: "20M+", privateClinicsVal: "1,200+", growthVal: "~7% CAGR", confidenceVal: "Средняя", digitVal: "Средняя", opportunity: "Возможность изучить гибкие модели партнерства с провайдерами, страховыми компаниями и сетями клиник.", dataNote: "Открытые данные лучше отражают частных провайдеров, участвующих в системе государственного финансирования или страхования, чем все частные клиники. Это публичный индикатор провайдеров, а не полный подсчет рынка." },
      ...
      tajikistan: { name: "Таджикистан", mapName: "Таджикистан", desc: "Открытая рыночная возможность с высокой потребностью в цифровой медицине и постепенно растущим частным сектором.", popVal: "10M+", privateClinicsVal: "900", growthVal: "~12% recent", confidenceVal: "Средняя", digitVal: "Низкая", opportunity: "Возможность изучить адаптированную к местным условиям цифровую инфраструктуру и модели партнерства.", dataNote: "Публичные сообщения указывают рост с 801+ частных медицинских учреждений в 2024 году до примерно 900 в 2025 году. Долгосрочный рост с 2012 года ближе к низким однозначным значениям, поэтому тренд не следует преувеличивать." },
      turkmenistan: { name: "Туркменистан", mapName: "Туркменистан", desc: "Региональная рыночная возможность, требующая отдельной оценки из-за ограниченности надежной открытой информации.", popVal: "6M+", privateClinicsVal: "Limited data", growthVal: "N/A", confidenceVal: "Низкая", digitVal: "Очень низкая", opportunity: "Открытая возможность для оценки при наличии надежных данных и подходящих локальных партнеров.", dataNote: "Надежных открытых данных о количестве клиник нет. Публичные источники описывают частный сектор здравоохранения как очень небольшой или ограниченный, поэтому нельзя придумывать число." }
    },
    drivers: {
      title: "Почему сейчас?",
